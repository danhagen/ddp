...
def cart_pole_iLQR(X_o,**params):
    """
    Takes in the initial position (X_o) of the system along with an optional set of parameters (params), and runs iLQR to meet some desired state.
    ...
    for k in range(NumberOfIterations):
        ...
        print(
            'iLQR Iteration %d,  Current TotalCost = %f \n'
            % (k+1,TotalCost[k])
        )
